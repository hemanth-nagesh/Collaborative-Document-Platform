"""
Django settings for collabdocs_project project.
...
SECRET_KEY = 'django-insecure-_-p6osdn-67v6f@3u%h()7ev*e7p=zs^d!602v^5%vwpcy_ugp'
...
ROOT_URLCONF = 'collabdocs_project.urls'
...
WSGI_APPLICATION = 'collabdocs_project.wsgi.application'
